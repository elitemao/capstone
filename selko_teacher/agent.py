...
grammar_agent = LlmAgent(
    ...
    instruction=load_instruction_from_file("grammar_instruction_4.txt")
    + "\n\nIMPORTANT: You are a background worker. "
          "Do NOT talk to the user. "
...
quiz_agent = LlmAgent(
    ...
    instruction=load_instruction_from_file("quiz_instruction_5.txt") 
    + "\n\nIMPORTANT: You are a background worker. "
          "Do NOT talk to the user. "
...
sentence_agent=LlmAgent(
	model=MODEL,
	name="split_sentence",
	instruction=load_instruction_from_file("split_instruction_2.txt")
	+ "\n\nIMPORTANT: You are a background worker. "
          "Do NOT talk to the user. "
