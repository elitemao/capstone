...
tts_agent = LlmAgent(
    ...
    name="selko_tts",
    instruction=(
        load_instruction_from_file("tts_instruction_SIMPLE_1.txt") # Create a new, simple instruction
    ),
...
router_agent = LlmAgent(
    model=MODEL,
    name="router",
    instruction=load_instruction_from_file("router_instruction_11.txt"),
